...
mem_init(void)
{
	...
	// LAB 3: Your code here.
	sz = ROUNDUP(NENV * sizeof(struct Env), PGSIZE);
	boot_map_region(kern_pgdir, UENVS, sz, PADDR(envs), PTE_U | PTE_P);
...
page_alloc(int alloc_flags)
{
	...
	if (alloc_flags & ALLOC_ZERO) memset(page2kva(allocated), 0, PGSIZE);
